...
* File Name: main.c
*
* Description: This code example demonstrates OTA update with XMC7000 MCU
* over Ethernet. The device establishes a connection with the designated
* MQTT Broker (AWS is used in this example) and subscribes to a topic.
* It periodically checks the job document to see if a new update is
